# https://github.com/vikashishere/YT-MLOPS-Complete-ML-Pipeline/blob/main/src/model_building.py
import os
import numpy as np
import pandas as pd
import pickle 
...
def main():
    try:
        params = load_params('params.yaml', logger=logger)['model_building']
